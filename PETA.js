...
motivo1.addEventListener("click", (event) => {
    ...
    img1.setAttribute("src", "linguaParaFora.jpg");
    ...
    p1.innerText = "O jeito que viramos 2 crianças do lado um do outro"
...
motivo2.addEventListener("click", (event) => {
    ...
    img2.setAttribute("src", "ursinho.jpg");
    img2.setAttribute("class","card-img-top img-fluid")
    divFoto.appendChild(img2)
    const p2 = document.createElement("p")
    p2.innerText = "Você ser minha princesa que eu tenho que bajular"
...
motivo3.addEventListener("click", (event) => {
   ...
   // const divP3 = document.querySelector(".p3")
    ...
    img3.setAttribute("src", "gostosa.jpg");
    img3.setAttribute("class","card-img-bottom img-fluid")
    divFoto.appendChild(img3)
    const p3 = document.createElement("p")
    p3.innerText = "Não posso deixar de dizar o quanto você é gostosa"
